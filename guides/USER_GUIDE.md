...
Note: This is the original `readme` that shipped with the generated app. It has some useful information & links that are not present in the github project's [readme](https://github.com/react-community/create-react-native-app#create-react-native-app).
